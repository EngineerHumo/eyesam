...
def main() -> None:
    ...
    parser.add_argument(
        "--checkpoint",
        default="/home/wensheng/gjq_workspace/eyesam/exp_log_260119_faz_batch2/checkpoints/best_dice_epoch_0109_no_click_0p903540.pt",
